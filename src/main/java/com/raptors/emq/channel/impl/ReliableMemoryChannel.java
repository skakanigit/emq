...
@ConditionalOnProperty(name = "channelType", havingValue = "reliable-memory")
@Service
public class ReliableMemoryChannel implements Channel {

	private static final Logger LOG = LoggerFactory.getLogger(ReliableMemoryChannel.class);

	private final Sink sink;

	@Autowired
	public ReliableMemoryChannel(Sink sink) {
		this.sink = sink;
	}
